  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log(
          "see the url for apppointment" + ApiService.appointmentList()
        );
        ...
        console.log("Some error occured on the server side " + error);
      }
    };
    fetchData();
  }, [appointments]);
          ...
          <div className="mb-8 flex items-center justify-between gap-8">
            ...
            <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
              <Button
                ...
                size="sm"
              >
                <UserPlusIcon strokeWidth={2} className="h-4 w-4" /> Book
                Appointment
              </Button>
            </div>
          </div>
